                    ...
                    @foreach($kelompok as $i => $k)
                        <tr style="border-bottom: 1px solid #eee;">
                            ...
                            <td style="text-align: center; padding: 12px;">
                                <a href="/hasil-apl/detail/{{ $k->id_kelompok }}?periode_id={{ session('periode_id') }}" class="btn btn-sm" style="background: #1e7e34; color: white; padding: 6px 12px; border-radius: 4px; text-decoration: none;">
                                    Detail
                                </a>
                            </td>
                        </tr>
